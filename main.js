...
bot.hears('🎁 Surprise',async (ctx) =>{
    ...
    try{
        ...
        let text = "*🤞 You May Join Our Channel To Get Surprise Giveaway & Loots*\n\n*🤝 Join* : [OneMoney](https://t.me/OpOneMoney)"
    ...
    try{
        ...
        if (ctx.message.text == '🚫 Cancel') {
            ...
            ctx.replyWithMarkdown(
                ...
                '*🚫 Please Set Minimum Withdraw To 1 Or Above*', { reply_markup: { keyboard:mainkey, resize_keyboard: true } }
